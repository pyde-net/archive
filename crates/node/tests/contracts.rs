...
pub fn all_contracts() -> Vec<ContractSpec> {
    vec![
        // Simple (10)
        ContractSpec { name: "Counter", source: COUNTER, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "CounterArgs", source: COUNTER_ARGS, is_multi: false, has_constructor_args: true, has_payable: false },
        ContractSpec { name: "SimpleStore", source: SIMPLE_STORE, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Accumulator", source: ACCUMULATOR, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Ownership", source: OWNERSHIP, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Piggybank", source: PIGGYBANK, is_multi: false, has_constructor_args: false, has_payable: true },
        ContractSpec { name: "Whitelist", source: WHITELIST, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "RateCounter", source: RATE_COUNTER, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Bitmap", source: BITMAP, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "MultiSlot", source: MULTISLOT, is_multi: false, has_constructor_args: false, has_payable: false },
        // Complex (12)
        ContractSpec { name: "Vault", source: VAULT, is_multi: false, has_constructor_args: false, has_payable: true },
        ContractSpec { name: "Token", source: TOKEN, is_multi: false, has_constructor_args: true, has_payable: false },
        ContractSpec { name: "Staking", source: STAKING, is_multi: false, has_constructor_args: true, has_payable: true },
        ContractSpec { name: "MathHeavy", source: MATH_HEAVY, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Lottery", source: LOTTERY, is_multi: false, has_constructor_args: false, has_payable: true },
        ContractSpec { name: "Registry", source: REGISTRY, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Escrow", source: ESCROW, is_multi: false, has_constructor_args: true, has_payable: true },
        ContractSpec { name: "Multisig", source: MULTISIG, is_multi: false, has_constructor_args: true, has_payable: false },
        ContractSpec { name: "Timelock", source: TIMELOCK, is_multi: false, has_constructor_args: true, has_payable: false },
        ContractSpec { name: "AmmPool", source: AMM_POOL, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "Voting", source: VOTING, is_multi: false, has_constructor_args: false, has_payable: false },
        ContractSpec { name: "StackHeapStress", source: STACK_HEAP_STRESS, is_multi: false, has_constructor_args: false, has_payable: false },
        // Factory + cross-contract (1 multi-contract file)
        ContractSpec { name: "TokenFactory", source: TOKEN_FACTORY, is_multi: true, has_constructor_args: false, has_payable: false },
    ]
}
