...
safety_fixture!(
    safety_prediction_market,
    "fixtures/programs/games/prediction_market.oti"
);
safety_fixture!(
    safety_rock_paper_scissors,
