...
typecheck_fixture!(
    typecheck_nft_marketplace,
    "fixtures/programs/nft/nft_marketplace.oti"
);
typecheck_fixture!(
    typecheck_nft_auction,
...
typecheck_fixture!(
    typecheck_rental_agreement,
    "fixtures/programs/realestate/rental_agreement.oti"
);
typecheck_fixture!(
    typecheck_fractional_ownership,
